...
const Contact = () => {
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-12">
      <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-900">Contact Us</h1>
    </div>
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="flex flex-wrap -m-2">
        ...
        <div class="p-2 w-full">
          <button class="flex mx-auto text-white bg-[#4d47f8] border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Send</button>
        </div>
        <div class="p-2 w-full pt-8 mt-8 border-t text-center">
          <a class="text-black">contact@uni.dao</a>
          <p class="leading-normal my-5 text-black">49 Kavacik St.
            <br />Istanbul, MN 56301
          </p>
          <span class="inline-flex">
          <a class="ml-3 text-black" href='https://twitter.com/medipolDAO' target="_blank">
      ...
      <a class="ml-3 text-black" href='https://www.linkedin.com/company/medipoldao' target="_blank">
